...
class AdminController extends Controller
{
  ...
  public function insertUsers()
  {
    ...
    return redirect()->route('admin')->with(['insertedUsersCount' => $insertedUsersCount, 'insertedAnatheseisCount' => $insertedAnatheseisCount, 'usersFailures' => $failures]);
  }
  ...
  public function insertStudents()
  {
    ...
    $failures = $import->failures();
    return redirect()->route('admin')->with(['insertedStudentsCount' => $insertedStudentsCount, 'insertedTmimataCount' => $insertedTmimataCount, 'studentsFailures' => $failures]);
  }
  ...
  public function insertProgram()
  {
    ...
    $failures = $import->failures();
    return redirect()->route('admin')->with(['insertedProgram' => 1, 'programFailures' => $failures]);
  }
